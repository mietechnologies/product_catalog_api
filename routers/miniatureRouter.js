...
router.get('/search', optionalAuth, miniatureController.searchMinis);                // Search miniatures by text
router.get('/:productCode', optionalAuth, miniatureController.getMiniByCode);        // Get a miniature by product code
